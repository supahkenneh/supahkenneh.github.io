const projects = [
  ...
  },
  {
    case: 'gimmegimme',
    name: 'Gimme Gimme',
    description: 'Node Knockout 2018 Hackathon submission and winner of Popularity Category. Players create and join game rooms. Game displays a prompt where users then submit a photo matching the prompt for game points. Click on name to visit the website.',
